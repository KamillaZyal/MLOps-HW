...
class LightMNISTClassifier(pl.LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        print(f'Train accuracy: {self.accuracy(torch.Tensor(self.prediction_train),torch.Tensor(self.correct_train))}')
    ...
    def on_validation_epoch_end(self):
        ...
        print(f'Validation accuracy: {self.accuracy(torch.Tensor(self.prediction_val),torch.Tensor(self.correct_val))}')
